...
display( void )
{
   glClear( GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT  ); 
    ...
    drawCube(Translate(0.5, 0.5, 0) * Scale(0.3) * RotateX(angle) * RotateY(angle) * Translate(0.6, 0.6, 0.6));
    drawCube(Translate(-0.5, 0.5, 0) * Scale(0.3) * RotateX(angle) * Translate(0.6, 0.6, 0.6) * RotateY(angle));
    drawCube(Translate(0.5, -0.5, 0) * Scale(0.3) * Translate(0.6, 0.6, 0.6) * RotateX(angle) * RotateY(angle));
