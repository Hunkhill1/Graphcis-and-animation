...
GLuint sinAngle, cosAngle, matrixID;
...
init( void )
{
    ...
    // mat2 multipliers_mat = mat2( vec2(cos(angle), -sin(angle)), vec2(sin(angle),  cos(angle))  );
    ...
    GLuint program = InitShader( "vrotate2dtriangleb.glsl", "fshader24.glsl" );
